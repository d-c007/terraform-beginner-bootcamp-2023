...
class Home
    # Active model is port of ruby on rails
    # It is used as an ORM. It has a module within.
    # Active Model that provides validation
    # The production Terratowns server is rails and uses 
    # very similiar and in most coses identical validation
  ...
  Validate :town, presence: true, inclusion: { in: [
    'melomaniac-mansion',
    'cooker-cove',
    'video-valley',
    'the-nomad-pad',
